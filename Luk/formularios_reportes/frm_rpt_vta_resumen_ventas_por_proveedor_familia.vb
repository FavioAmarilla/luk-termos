...
Public Class frm_rpt_vta_resumen_ventas_por_proveedor_familia

    Private venta As New func_ventas
    Private dt_ventas As New DataTable
    Private util As New utilidades
    Private TITULO_MSJ As String = "<Resumen de Ventas por Proveedor - Familia>"

    Private ID_PROVEEDOR As Integer = 0

    Private Sub frm_rpt_vta_ventas_por_proveedor_familia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub consultar()
        ...
        Dim orden As String = " GROUP BY vta.fecha_venta, p.nombre, f.descripcion, vta.fecha_venta ORDER BY p.nombre, vta.fecha_venta ASC"
        ...
        dt_ventas = venta.consultar("SELECT vta.fecha_venta, COALESCE(p.nombre, 'NO DEFINIDO') AS proveedor, COALESCE(f.descripcion, 'NO DEFINIDO') AS familia, SUM(iv.cantidad) AS cantidad, 
                                        SUM(vta.costo_total) AS costo_total, SUM(vta.gravados) AS gravados, SUM(vta.impuestos) AS impuestos, 
                                        SUM(vta.total_venta) AS total_venta
                                        FROM ventas vta
                                        ...
                                        sucursal + proveedor + desde + hasta + " AND vta.fecha_anulacion IS NULL " + orden)
    ...
    Private Sub btn_buscar_sucursal_Click(sender As Object, e As EventArgs) Handles btn_buscar_sucursal.Click
        ...
        frm.FRM_ACTIVO = "frm_rpt_vta_ventas_por_proveedor_familia"
    ...
    Private Sub btn_imprimir_Click(sender As Object, e As EventArgs) Handles btn_imprimir.Click
        If GridView1.RowCount <= 0 Then
            ...
            Return
        End If
        Dim report As New rpt_vta_resumen_ventas_por_proveedor_familia
