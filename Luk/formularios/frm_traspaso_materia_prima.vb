Public Class frm_traspaso_materia_prima

    Private familia As New func_familias_materia_prima
    Private util As New utilidades
    Private TITULO_MSJ As String = "<Traspaso de Materias Primas>"

    Private Sub frm_traspaso_materia_prima_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txt_linea.Focus()
    End Sub

    Public Sub obtener_linea_padre(id As String)
        Dim dt As DataTable
        dt = familia.listar("SELECT identificador, descripcion FROM familias_materia_prima WHERE identificador='" + id + "'")
    ...
    Private Sub btn_buscar_linea_padre_Click(sender As Object, e As EventArgs) Handles btn_buscar_linea_padre.Click
        ...
        frm.FRM_ACTIVO = "frm_traspaso_materia_prima"
        frm.Show()
    End Sub
