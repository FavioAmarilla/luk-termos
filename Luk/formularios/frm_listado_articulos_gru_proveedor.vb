...
Public Class frm_listado_articulos_gru_proveedor
    ...
    Private Sub frm_listado_articulos_gru_proveedor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txt_familia_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_familia.KeyDown
        If e.KeyCode = Keys.F9 Or e.KeyCode = Keys.Space Then
            Dim frm As New frm_vista_familias
            frm.FRM_ACTIVO = "frm_listado_articulos_gru_proveedor"
            frm.Show()
        End If
