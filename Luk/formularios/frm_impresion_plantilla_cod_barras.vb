...
Public Class frm_impresion_plantilla_cod_barras

    Dim cont_articulo As New func_articulos
    Dim util As New utilidades
    Dim dt_impresion As New DataTable

    Private Sub frm_impresion_plantilla_cod_barras_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        limpiar()
        crear_cursor()
    End Sub
    ...
    Function add_item_impresion() As DataTable
        Try
            ...
            For i As Integer = 0 To dt_impresion.Rows.Count - 1
                limite = dt_impresion.Rows(i).Item(2)
    ...
    Private Sub txtCodigo_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_codigo.KeyDown
        ...
        If e.KeyCode = Keys.F9 Or e.KeyCode = Keys.Space Then
            ...
            frm.FRM_ACTIVO = "frm_impresion_plantilla_cod_barras"
            frm.Show()
        End If
    End Sub
    ...
    Private Sub btn_imprimir_Click(sender As Object, e As EventArgs) Handles btn_imprimir.Click
        ...
        Dim report As New rpt_impresion_plantilla_cod_barras
