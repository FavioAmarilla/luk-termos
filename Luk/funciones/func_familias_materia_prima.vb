...
Public Class func_familias_materia_prima
    ...
    Public Function listar(ByVal sql As String) As DataTable
        ...
        Catch ex As Exception
            util.mensajes("Error al Realizar Consulta: " + ex.Message, "func_familias_materia_prima_materia_prima", "ERR")
            Return Nothing
        Finally
            desconectar()
        End Try
    ...
    Public Function validar_familia_articulo(codigo As String) As Boolean
        Try
            ...
            Dim dt = New DataTable()
            Dim ds As New DataSet
            Dim da As NpgsqlDataAdapter = New NpgsqlDataAdapter("SELECT 1 FROM materiales m
    ...
    Public Function insertar(descripcion As String, nivel As Integer, ultimo_nivel As Boolean, codigo As String, id_linea_padre As Integer, nro_item As Integer) As Boolean
        Try
            conectar()
            Dim comand As New NpgsqlCommand("INSERT INTO familias_materia_prima(descripcion, nivel, ultimo_nivel, codigo, id_linea_padre, nro_item)
            ...
            End If
        Catch ex As Exception
            util.mensajes("Error al Registrar Familia: " + ex.Message, "func_familias_materia_prima_materia_prima", "ERR")
            Return False
        Finally
            desconectar()
        End Try
    ...
    Public Function actualizar(ultimo_nivel As Boolean, identificador As Integer, descripcion As String) As Boolean
        Try
            conectar()
            Dim comand As New NpgsqlCommand("UPDATE familias_materia_prima SET ultimo_nivel=@ultimo_nivel, descripcion=@descripcion, fec_mod=now()
            ...
            End If
        Catch ex As Exception
            util.mensajes("Error al Actualizar Familia: " + ex.Message, "func_familias_materia_prima_materia_prima", "ERR")
            Return False
        Finally
            desconectar()
        End Try
    ...
    Public Function eliminar(identificador As Integer) As Boolean
        Try
            conectar()
            Dim comand As New NpgsqlCommand("DELETE FROM familias_materia_prima WHERE identificador=@identificador", cnn)
            ...
            End If
        Catch ex As Exception
            util.mensajes("Error al Eliminar Familia: " + ex.Message, "func_familias_materia_prima", "ERR")
            Return False
        Finally
            desconectar()
        End Try
    ...
    Public Function actualizar_familia_articulo(id_familia_valor As Integer, id_familia As Integer) As Boolean
        Try
            conectar()
            Dim comand As New NpgsqlCommand("UPDATE materiales SET id_familia=@id_familia_valor WHERE id_familia=@id_familia", cnn)
            ...
            End If
        Catch ex As Exception
            util.mensajes("Error al Realizar Traspaso: " + ex.Message, "func_familias_materia_prima", "ERR")
            Return False
        Finally
            desconectar()
        End Try
